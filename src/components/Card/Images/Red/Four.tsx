...
const SvgFour = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#four_svg__a)">
      ...
      <path d="M0 .148h2329.5v3235.207H0zm0 0" fill="#f66462" />
    </g>
    ...
    <use xlinkHref="#four_svg__e" x={40.494} y={575.222} fill="#f66462" />
    <use xlinkHref="#four_svg__e" x={1904.094} y={3095.175} fill="#f66462" />
  </svg>
);
