...
const SvgSeven = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#seven_svg__a)">
      ...
      <path d="M0 .145h2329.5v3235.21H0zm0 0" fill="#2fe39b" />
    </g>
    ...
    <use xlinkHref="#seven_svg__e" x={40.494} y={575.22} fill="#2fe39b" />
    <use xlinkHref="#seven_svg__e" x={1904.094} y={3095.174} fill="#2fe39b" />
  </svg>
);
